...
OFFICIAL_PROFILES = {
    ...
    'libu': {
        'name': '扫地僧', 'emoji': '📝', 'role': '正二品·藏经阁',
        'duty': '学习路径与知识沉淀。负责学习体系设计、知识结构梳理、学习问答沉淀；制定学习内容输出规范和模板。',
...
2. **每位官员必须从自己的职责领域出发发言**——户部谈成本和数据、兵部谈安全和运维、研发部谈技术实现、刑部谈质量和合规、藏经阁谈学习路径与知识沉淀、吏部谈人员安排、中书谈规划方案、门下谈审查风险、尚书谈执行调度、太子谈创新和大局，每个人关注的焦点不同
...
_SIMULATED_RESPONSES = {
    ...
    'shangshu': [
        '若方案通过，臣立刻安排各部分头执行——研发部负责实现，兵部保障运维。',
        '臣来说说执行层面的分工：此事当由研发部主导，户部配合数据支撑。',
